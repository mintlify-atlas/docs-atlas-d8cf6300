...
When the source and destination hosts are different, the path receives a one-level severity bump (e.g., HIGH → CRITICAL). This reflects the increased practical impact of cross-host relay attacks.
